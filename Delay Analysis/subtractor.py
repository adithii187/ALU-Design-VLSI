...
for j in range(0,8):
    ...
    for i in range(0,4):
        ...
        if(j<4):
            fp1 = open("../magic_files/sub_pulse_a.ckt",'r')
            mode1 = "RISE"
            mode2 = "RISE"
            mode3 = "FALL"
            mode4 = "FALL"
        else:
            fp1 = open("../magic_files/sub_pulse_b.ckt",'r')
            mode1 = "RISE"
            mode2 = "FALL"
            mode3 = "FALL"
            mode4 = "RISE"

        fp2 =open("delay_subtractor_calc.ckt",'w')
        fp3 = open("subtractor.txt",'a')
